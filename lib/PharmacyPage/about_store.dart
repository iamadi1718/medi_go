...
class _AboutStorePageState extends State<AboutStorePage> {
  ...
  Widget _buildCategoryChips() {
    final categories = ["All", "Medicines", "Baby Care", "Suppliments", "First Aid"];
          ...
          return Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFF0F8894) : Colors.white,
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
                    color: isSelected ? const Color(0xFF0F8894) : Colors.grey.shade300,
                    width: 1.5,
                  ),
                ),
                child: Text(
