...
import 'package:medi_go/bookappointment/appointconfirm.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    hint: Text("Select Speciality", style: TextStyle(color: Colors.grey.shade600, fontSize: 14)),
                    items: const [
                    ...
                    child: AbsorbPointer(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: const Icon(Icons.calendar_today_outlined, color: Colors.black87, size: 20),
                          filled: true,
                          fillColor: const Color(0xFFEEEEEE),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(24),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: carouselDates.map((date) {
                        ...
                        return GestureDetector(
                          ...
                          child: dateBox(_getWeekdayAbbr(date), date.day.toString(), isSelected),
                        );
                      }).toList(),
                    ),
                  ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AppointConfirmScreen(
  ...
  Widget dateBox(String day, String date, bool selected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: selected ? null : Border.all(color: Colors.grey.shade300, width: 1.2),
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
